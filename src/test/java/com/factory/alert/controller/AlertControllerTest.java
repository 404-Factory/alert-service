...
class AlertControllerTest {
    ...
    void getAlerts() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/alerts")
            ...
            .andExpect(jsonPath("$.data.content[0].equipmentId").value("EQ-001"))
    ...
    void getAlert() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/alerts/{id}", 1L))
            .andDo(print())
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.success").value(true))
            .andExpect(jsonPath("$.status").value(200))
            ...
            .andExpect(jsonPath("$.data.equipmentId").value("EQ-001"))
    ...
    void updateAlerts() throws Exception {
        ...
        mockMvc.perform(patch("/api/v1/alerts")
    ...
    void updateAlert() throws Exception {
        ...
        mockMvc.perform(patch("/api/v1/alerts/{id}", 1L)
                .contentType("application/json")
                .content(requestBody))
            .andExpect(status().isNoContent());
    ...
    void getAlertThrowsAlertNotFound() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/alerts/{id}", 999L))
    ...
    void updateAlertThrowsAlertNotFound() throws Exception {
        ...
        mockMvc.perform(patch("/api/v1/alerts/{id}", 999L)
                .contentType("application/json")
                .content(requestBody))
            .andExpect(status().isNotFound());
    ...
    // Jakarta Bean Validation error since invalid parameters were provided.
    @Test
